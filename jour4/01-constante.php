...
//il est possible de créer des constantes en php
//il faut passer par fonction
...
echo "j'ai {STATUS} ma facture <br>";// ca ne marche pas
echo "j'ai" . STATUS ." ma facture <br>";// utiliser les .    
// nouvelle manière de créer une constaante
...
//cas pratique => récupérer le nom du fichier actuellement exécuté ??
