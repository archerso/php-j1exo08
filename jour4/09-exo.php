...
if( !empty($_GET) &&       // est ce que j'ai une partie variable dans l'url
    isset($_GET["nom"])){  // est la partie variable contient nom= OU Y A T IL =ISSET //ESt ce QUE GET CONTIENT l'élément qui a l'index nommé "nom"
...
<!-- //DIFFERENT MAIS PROCHE DE BOOSTRAP -->
</head>
<body>
    <header>
        <nav class="container">
