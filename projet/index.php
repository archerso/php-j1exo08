...
<link rel="stylesheet" a href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css">
</head>
...
<header class="bg-success">
    <nav class="navbar navbar-expand navbar-dark container">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a href="index.php?page=presentation" class="nav-link">Presentation</a>
            </li>
        </ul>

        <ul class="navbar-nav ms-auto">
            <li class="nav-item">
                <a href="index.php?=login" class="nav-link">Login</a>
            </li>
            
            <li class="nav-item">
                <a href="index.php?=accueil&partie=privee" class="nav-link">Tableau de bord</a>
            </li>
        </ul>
    </nav>
...
<!-- on va gérer tout ce qui est front office -->
...
<?php else : ?>
    <?php require "vue/privee/gestion/404.php"?>
<?php endif ?>
    <script>
