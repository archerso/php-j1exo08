...
dans cette page créer un formulaire news letter
champ dans lequel vous pouvez saisir un  emmail
champ de type menu déroulant <select> 3 valeurs possibles français /anglais/arabe
    ...
    que le menu déroulant vous donne français/anglais

    //si tout est conforme => afficher sous le formulaire le texte merci
    //si ce n'est pas conforme => expliquez les erreurs réalisé

    // en cas d'erreur => récupérer les informations saisies avant soumissions pour éviter que la personne remplisse intégralement le formulaire
-->
